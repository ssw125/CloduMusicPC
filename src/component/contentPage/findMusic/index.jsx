import { Menu,Carousel,Skeleton, Spin } from 'antd'
    ...
    return (
        <div style={{padding:20}}>
            <Menu style={{border:0,fontSize:18,marginTop:10}}  mode="horizontal" defaultSelectedKeys="1">
                ...
                <Menu.Item key="2"><NavLink to='recomment'>个性推荐</NavLink></Menu.Item>
                <Menu.Item key="3"><NavLink to='recomment'>个性推荐</NavLink></Menu.Item>
                <Menu.Item key="4"><NavLink to='recomment'>个性推荐</NavLink></Menu.Item>
                <Menu.Item key="5"><NavLink to='recomment'>个性推荐</NavLink></Menu.Item>
            </Menu>
